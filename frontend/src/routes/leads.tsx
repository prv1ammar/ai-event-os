...
function getLeadScore(l: Lead): number {
  return l.lead_score ?? l.score ?? 0;
}

function getInterestLevel(l: Lead): string {
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative flex-1 min-w-[220px]">
              ...
              <Input
                ...
                className="h-9 pl-9 bg-card text-sm"
                value={search}
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className={cn(
                            "inline-flex rounded-md border px-2 py-0.5 text-xs font-medium mt-1",
